/*
A different type of bitcrusher effect, this time by reducing the sample rate.
Only every n:th sample will "fresh", the previous one will be held and looped in the meantime.
*/
